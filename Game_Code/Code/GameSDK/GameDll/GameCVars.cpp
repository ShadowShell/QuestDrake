...
void SCVars::InitCVars(IConsole *pConsole)
{
	...
	REGISTER_CVAR(pl_movement.strafe_SpeedScale, 0.3f, 0, "Strafe speed scale");
	REGISTER_CVAR(pl_movement.sprint_SpeedScale, 3.0f, 0, "Sprint speed scale");
	//CodeChange - 0.0.3
	REGISTER_CVAR(pl_movement.doubleQuick_SpeedScale, 2.0f, 0, "DoubleQuick speed scale");
...
void SCVars::ReleaseCVars()
{
	...
	pConsole->UnregisterVariable("pl_movement.doubleQuick_SpeedScale", true);
