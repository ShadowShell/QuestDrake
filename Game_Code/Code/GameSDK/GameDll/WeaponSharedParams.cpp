...
void SZoomSway::Reset( const XmlNodeRef& paramsNode, bool defaultInit /*= true*/ )
{
	if (defaultInit)
	{
		maxX = 0.000f;
		maxY = 0.000f;
		stabilizeTime = 3.000f;
		destabilizeTime = 3.000f;
		holdBreathScale = 0.100f;
		holdBreathTime = 1.000f;
		coverScale = 0.600f;
		coverScaleTime = 0.750f;
		minScale = 0.150f;
		scaleAfterFiring = 0.500f;
		crouchScale = 0.800f;
	}
	...
	if (paramsNode)
	{
		...
		reader.ReadParamValue<float>("destabilizeTime", destabilizeTime);
